...
const PROFILE = {
  ...
  about: ["I am a PhD student in Computer Science at Kyiv National University of Construction and Architecture (KNUCA), advised by Dr. Tetyana Honcharenko. My published work spans computer vision for construction site analytics, BIM-driven digital twins, multimodal sentiment analysis with explainable AI, graph and sequence models for environmental and sensor forecasting, and natural language processing for the low-resource Ukrainian language.", "I lead BUDOVA, an open Ukrainian voice & text archive selected by Microsoft Research's LINGUA Open Call, where we build NLP resources for a low-resource language with construction-domain NER annotations and an ASR baseline. In parallel I head a state-funded project on AI-agent digital twins for damaged infrastructure, and contribute to work on multimodal sentiment analysis with explainable AI.", "My papers have appeared in Water (MDPI, Q1), REKS, IEEE SIST, FRUCT, Springer LNNS and CEUR-indexed proceedings; one received the DTESI 2024 Best Paper Award. I hold the Scholarship of the President of Ukraine for PhD students and have been recognized by the Victor Pinchuk Foundation's Zavtra.UA program."]
};
...
const LINKS = [{
  ...
  url: "https://scholar.google.com/citations?user=I54c3uQAAAAJ&hl=en",
  kind: "scholarly"
}, {
  label: "ORCID",
  url: "https://orcid.org/0000-0001-9418-0943",
  kind: "scholarly"
}, {
  label: "Scopus",
  url: "https://www.scopus.com/authid/detail.uri?authorId=57994271400",
  kind: "scholarly"
}, {
  label: "Web of Science",
  url: "https://www.webofscience.com/wos/author/record/ACU-8785-2022",
  kind: "scholarly"
}, {
  label: "DBLP",
  url: "https://dblp.org/pid/336/0687.html",
  kind: "scholarly"
}, {
  label: "Semantic Scholar",
  url: "https://www.semanticscholar.org/author/S.-Dolhopolov/2191831037",
  kind: "scholarly"
}, {
  label: "ResearchGate",
  url: "https://www.researchgate.net/profile/Serhii-Dolhopolov",
  kind: "scholarly"
}, {
  label: "LinkedIn",
  url: "https://www.linkedin.com/in/serhii-dolhopolov-aa4099193/",
  kind: "social"
}, {
  label: "GitHub",
  url: "https://github.com/F1-bot",
  kind: "social"
}];
...
// ---- 2025 ------------------------------------------------------------
{
  ...
  thumb: "sensor-graph",
  links: {
    doi: "https://doi.org/10.1109/SIST61657.2025.11139225",
    bib: "dolhopolov2025sist_water"
  }
}, {
  id: "pub-2025-04",
  selected: true,
  ...
  links: {
    doi: "https://doi.org/10.1109/SIST61657.2025.11139261",
    bib: "honcharenko2025sist_face"
  }
}, {
  id: "pub-2025-06",
  selected: false,
  ...
  thumb: "grad-cam",
  links: {
    pdf: "https://ceur-ws.org/Vol-4146/paper27.pdf",
    bib: "dolhopolov2025ittap"
  }
}, {
  id: "pub-2025-07",
  selected: false,
  ...
  thumb: "preprocess",
  links: {
    pdf: "http://mdcs.knuba.edu.ua/article/view/335160",
    bib: "dolhopolov2025preprocess"
  }
}, {
  id: "pub-2025-09",
  selected: true,
  ...
  thumb: "neuro-phys",
  links: {
    doi: "https://link.springer.com/chapter/10.1007/978-3-031-90735-7_27",
    bib: "dolhopolov2025neurophysnet"
  }
},
// ---- 2024 ------------------------------------------------------------
{
  ...
  thumb: "site-yolo",
  links: {
    pdf: "https://ceur-ws.org/Vol-3966/W3Paper11.pdf",
    bib: "dolhopolov2024yolov5_safety"
  }
}, {
  id: "pub-2024-02",
  selected: true,
  ...
  thumb: "yolo-compare",
  links: {
    pdf: "https://ceur-ws.org/Vol-3966/W3Paper10.pdf",
    bib: "dolhopolov2024yolov8_10"
  }
}, {
  id: "pub-2024-03",
  selected: false,
  ...
  thumb: "yolo-classes",
  links: {
    pdf: "https://ceur-ws.org/Vol-3896/paper4.pdf",
    bib: "dolhopolov2024yolov5_equip"
  }
}, {
  id: "pub-2024-04",
  selected: false,
  ...
  links: {
    pdf: "https://ceur-ws.org/Vol-3896/paper3.pdf",
    bib: "dolhopolov2024yolo_study"
  }
}, {
  id: "pub-2024-05",
  selected: false,
  ...
  thumb: "threat-detect",
  links: {
    doi: "https://doi.org/10.1109/SIST61555.2024.10629526",
    bib: "dolhopolov2024sist_threat"
  }
}, {
  id: "pub-2024-06",
  selected: false,
...
// ---- 2023 ------------------------------------------------------------
{
  ...
  thumb: "bim-scan",
  links: {
    doi: "https://doi.org/10.1109/SIST58284.2023.10223543",
    bib: "dolhopolov2023sist_bim"
  }
},
// ---- 2022 ------------------------------------------------------------
{
  ...
  thumb: "twin-mirror",
  links: {
    doi: "https://doi.org/10.1109/CSIT56902.2022.10000717",
    bib: "chernyshev2022csit"
  }
}, {
  id: "pub-2022-02",
  selected: false,
  ...
  thumb: "object-detect",
  links: {
    pdf: "https://ceur-ws.org/Vol-3309/short10.pdf",
    bib: "chernyshev2022ittap"
  }
}, {
  id: "pub-2022-03",
  selected: false,
  ...
  links: {
    doi: "https://doi.org/10.1109/SIST54437.2022.9945752",
    bib: "dolhopolov2022sist_career"
  }
}];
const TOPIC_LABEL = {
  ml: "Machine Learning",
...
const PROJECTS = [{
  ...
  role: "Project Leader",
  members: ["S. Dolhopolov (lead)", "I. Bosenko", "O. Matsiievskyi", "V. Kontsevyi", "I. Maksymiuk", "M. Omelchenko"],
  ...
  description: "A multi-agent AI system for automated dynamic verification and monitoring of digital twins of damaged infrastructure objects. The approach combines deep learning for computer vision and point-cloud analysis with a collaborative multi-agent architecture that autonomously updates BIM/IFC models from heterogeneous photogrammetry and LiDAR data, enabling rapid and objective damage assessment to support Ukraine's reconstruction.",
  links: [{
  ...
  members: ["Dr. T. Honcharenko (lead)", "S. Dolhopolov", "Dr. O. Poplavskyi", "Dr. O. Molodid", "M. Delembovskyi", "Y. Riabchun"],
  ...
  links: [{
    label: "Project documentation",
    url: "https://nddkr.ukrintei.ua/view/rk/b5897c60b0cb91bdc3dd28480445dd12"
  }, {
    label: "REKS 2025 paper",
    url: "https://doi.org/10.32620/reks.2025.4.07"
  }, {
    label: "ITTAP 2025 paper",
...
const EDUCATION = [{
  ...
  dates: "2024 — Present",
  notes: ["Scientific Advisor: Dr. Tetyana Honcharenko"]
}, {
  degree: "M.Sc. in Cyber Security",
  school: "Kyiv National University of Construction and Architecture",
  dates: "2022 — 2023",
  notes: ["Diploma with honours · GPA 97.43 / 100", "Scientific Advisor: Dr. Svitlana Kondakova"]
}, {
  degree: "B.Sc. in Vocational Education",
  degreeSub: "(Computer Technologies)",
  school: "Kyiv National University of Construction and Architecture",
  dates: "2018 — 2022",
  notes: ["Diploma with honours · GPA 100 / 100", "Comprehensive State Exam: 100 / 100"]
}];
...
const TEACHING = [{
  course: "Programming in the Python language",
  dates: "Fall 24/25 · Spring 25/26"
}, {
  course: "Artificial intelligence and hybrid networks",
  dates: "Fall 24/25"
}, {
  course: "Neural networks and AI systems in education",
  dates: "Fall 24/25"
}, {
  course: "Modeling of artificial intelligence tasks",
  dates: "Spring 24/25/26"
}, {
  course: "Object-oriented programming",
  dates: "Fall 23/24/25 · Spring 24/25/26"
}, {
  course: "Artificial intelligence and neural networks",
  dates: "Spring 25"
}, {
  course: "Applied AI and MLOps in the Software Development Process",
  dates: "Spring 26"
}, {
  course: "Artificial Intelligence: Foundations and Frontiers 🚀",
  dates: "Spring 24"
}];
const VOLUNTEER = [{
